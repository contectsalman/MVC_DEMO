...
namespace Bootstrapsdemo.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            var tbl_Employee = db.tbl_Employee.Include(t => t.tbl_dept);
        ...
        {
            ViewBag.Did = new SelectList(db.tbl_dept, "Did", "D_Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Eid,E_Name,E_Salary,E_Gender,E_DOB,Did")] tbl_Employee tbl_Employee)
        {
